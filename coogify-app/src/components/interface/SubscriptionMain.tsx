    ...
    >
      <div className="bg-gradient-to-t from-[#3E3C3C] from-85% to-[#9E67E4] to-100% rounded-md overflow-auto">
        ...
        <div className="w-full rounded-xl md:h-[calc(100vh-140px)] h-auto flex flex-row items-center gap-5 px-5 md:py-5 pb-20 pt-5 relative ">
          ...
          <Link to="">
            Subscription Plans
            <div className="w-96 h-30 py-9 rounded-lg text-4xl pl-7 font-bold mb-4 hover:bg-[#ddc5fc] bg-[#d1c9db] shadow-md shadow-[#d0c2e2] cursor-pointer">
              Free
              <div className="text-lg font-normal">$0.00/per month</div>
            </div>
            </Link>
            <div className="text-[#A263F2] w-96 h-30 py-9 rounded-lg text-4xl pl-7 font-bold mb-4 hover:bg-[#ddc5fc] bg-[#d1c9db] shadow-md shadow-[#d0c2e2] cursor-pointer" >
            <Link to="">
              Premium
            ...
            <div className="text-[#FFFF00] w-96 h-30 py-9 rounded-lg text-4xl pl-7 font-bold hover:bg-[#ddc5fc] bg-[#d1c9db] shadow-md shadow-[#d0c2e2] cursor-pointer">
            <Link to="">
              Student
              <div className=" text-white text-lg font-normal">
                $5.99/per month
