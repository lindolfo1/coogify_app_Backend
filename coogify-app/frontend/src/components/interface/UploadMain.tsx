...
<<<<<<< HEAD:coogify-app/src/components/interface/UploadMain.tsx
  const [songs, setSongs] = useState([{ name: '', file: "" }]);
=======
  const [songs, setSongs] = useState<{ name: string; file: File | null }[]>([
    { name: '', file: null },
  ]);
>>>>>>> e37af8c705ea4a94c00aea5450781de7c370e823:coogify-app/frontend/src/components/interface/UploadMain.tsx
